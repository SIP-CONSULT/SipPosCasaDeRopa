...
import net.sipconsult.sipposcasaderopa.ui.login.AuthenticationState
import net.sipconsult.sipposcasaderopa.ui.payment.TransactionResult
import net.sipconsult.sipposcasaderopa.util.Receipt
import net.sipconsult.sipposcasaderopa.util.ReceiptBuilder
...
//        }
    ...
    fun buildSalesTransactionReceipt() {
        ...
        val header: String = context.getString(R.string.company_name)
...
//        val salesAgentR = salesAgent.value!!
        ...
        receipt =
            if (discountType.value != null) {
                ReceiptBuilder()
                    .header(locationR.company)
                    .text(locationR.address)
//                    .text("Tel: ${locationR.telephone}")
                    .text("Mobile: ${locationR.mobilePhoneNumber1}")
...
//                    .text("Sales Agent: ${salesAgentR.displayName}")
    ...
    fun buildRefundTransactionReceipt() {
        ...
        receipt = ReceiptBuilder()
            .header(header)
            .text(locationR.address)
            .text("Tel: ${locationR.telephoneNumber}")
            .text("Mobile: ${locationR.mobilePhoneNumber1}")
            .text("WhatsApp: ${locationR.mobilePhoneNumber1}")
...
//            lateinit var paymentMethodItem: PaymentMethodItem
        ...
        val body = SaleTransactionPostBody(
            ...
            salesTransactionProducts = products,
            salesTransactionPaymentMethods = paymentMethods
        )
