...
import net.sipconsult.sipposcasaderopa.data.db.ProductsDao
...
//    }
    ...
    override fun productsCategory(categoryId: Int): LiveData<List<ProductItem>> {
        return productsDao.getProductCategory(categoryId)
    }
